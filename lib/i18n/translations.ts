...
export const translations: Record<Language, Translations> = {
  ...
  auth: {
    ...
    landing: {
      ...
      subtitle:
        "Norevi LifeSync снижает ментальную нагрузку: показывает безопасный лимит трат, напоминает о платежах и помогает планировать день без хаоса.",
    ...
    dashboard: {
      ...
      quickPayBillPaymentNote: "Оплачено из Norevi LifeSync",
    ...
    paymentsHistory: {
      title: "История оплат",
      subtitle: "Оплаты, сделанные через Norevi LifeSync",
      empty: "Пока нет оплат.",
      total: "Всего оплачено",
      manageRules: "Управление шаблонами",
      rulesTitle: "Шаблоны категорий",
      rulesHint: "Norevi LifeSync запоминает платёж и сам ставит категорию.",
      rulePattern: "Шаблон",
    ...
    assistant: {
      ...
      responses: {
        ...
        systemPrompt:
          "Ты помощник Norevi LifeSync. Отвечай кратко на русском, только в рамках финансов, платежей, напоминаний и планирования. Не выдумывай данные.",
    ...
    onboarding: {
      welcomeTitle: "Добро пожаловать в Norevi LifeSync",
  ...
  auth: {
    ...
    landing: {
      ...
      subtitle:
        "Norevi LifeSync reduces mental load: it shows a safe spending limit, reminds you about bills, and helps you plan the day without chaos.",
    ...
    dashboard: {
      ...
      quickPayBillPaymentNote: "Paid via Norevi LifeSync",
    ...
    paymentsHistory: {
      ...
      subtitle: "Payments made through Norevi LifeSync",
      empty: "No payments yet.",
      total: "Total paid",
      manageRules: "Manage rules",
      rulesTitle: "Category rules",
      rulesHint: "Norevi LifeSync learns from payments and auto-assigns categories.",
      rulePattern: "Pattern",
    ...
    assistant: {
      ...
      responses: {
        ...
        systemPrompt:
          "You are the Norevi LifeSync assistant. Reply briefly in English, only within finances, bills, reminders, and planning. Do not invent data.",
    ...
    onboarding: {
      welcomeTitle: "Welcome to Norevi LifeSync",
  ...
  auth: {
    ...
    landing: {
      ...
      subtitle:
        "Norevi LifeSync reduce sarcina mentala: arata limita sigura de cheltuieli, iti aminteste de plati si te ajuta sa planifici ziua fara haos.",
    ...
    dashboard: {
      ...
      quickPayBillPaymentNote: "Platita prin Norevi LifeSync",
    ...
    paymentsHistory: {
      title: "Istoric plati",
      subtitle: "Plati efectuate prin Norevi LifeSync",
      empty: "Nu exista plati.",
      total: "Total achitat",
      manageRules: "Gestionare sabloane",
      rulesTitle: "Sabloane de categorii",
      rulesHint: "Norevi LifeSync invata si aplica automat categoria.",
      rulePattern: "Sablon",
    ...
    assistant: {
      ...
      responses: {
        ...
        systemPrompt:
          "Esti asistentul Norevi LifeSync. Raspunde concis in romana, doar despre finante, plati, memento si planificare. Nu inventa date.",
    ...
    onboarding: {
      welcomeTitle: "Bun venit la Norevi LifeSync",
