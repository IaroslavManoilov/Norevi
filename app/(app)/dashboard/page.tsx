...
export default async function DashboardPage() {
  ...
  const [smartActionPreferenceScores, smartActionVariantPerformance] = await Promise.all([
    getSmartActionPreferenceScores(supabase, user.id),
    getSmartActionVariantPerformance(supabase, user.id),
  ]);
  const smartActionsVariant = resolveSmartActionsVariant(user.id, smartActionVariantPerformance);
  const smartActions = getSmartActions({
    language,
    variant: smartActionsVariant,
    preferenceScores: smartActionPreferenceScores,
    balance,
